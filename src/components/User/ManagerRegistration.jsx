...
const ManagerRegistration = ({ closeModal }) => {
    ...
    const handleRegistrationSubmit = async (e) => {
        ...
        if (
            ...
            try {
                ...
                const registrationResponse = await managerRegister(
                ...
                <div className='overlay '>
                    ...
                    {load && <Loading/>}
                        ...
                        <form className=" capitalize shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full">
                            <p className='uppercase text-center font-semibold'>Register new Manager</p>
