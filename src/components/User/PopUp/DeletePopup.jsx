...
import { DeleteMeeting } from '../../../server/Meet/DeleteMeeting';
import { useDispatch, useSelector } from 'react-redux';
import { meetingDelete } from '../../../store/Meet/MeetingSlice';
import { deleteBoard } from '../../../server/Task/DeleteBoard';
import { updateBoarddDeletion } from '../../../store/Task/BoardSlice';
import { updateCardDeleteion } from '../../../store/Task/cardSlice';
import { CardDelete } from '../../../server/Task/CardDelete';
        ...
        try {
            switch (type) {
                ...
                case 'board':
                    ...
                    if (boardResponse === 'Board deleted successfully') {
                ...
                case 'card':
                    ...
                    if (cardResponse==="Card deleted successfully") {
